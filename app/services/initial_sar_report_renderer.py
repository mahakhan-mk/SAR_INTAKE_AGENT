...
from app.application.models import InitialSarReportContext
...
class InitialSarReportRenderer:
    ...
    def render(
        self,
        preview: InitialSarReportContext,
        *,
    ...
    def _build_context(self, preview: InitialSarReportContext) -> dict[str, object]:
